...
- [Antigravity CLI](https://github.com/google-gemini/gemini-cli) version **v0.4.1** or higher
- [Antigravity 2.0](https://antigravity.google/product/antigravity-2) version **v0.4.1** or higher.
